...
6 个真实 GitHub 仓库 + 2 个个人项目 LLM-as-a-Judge 五维评测结果（2026-08-15 重测）：

| 产品 | 综合得分 | 定位 | 差异化 | 护城河 | 工程 | 可持续 | 类型 |
|------|:--:|:--:|:--:|:--:|:--:|:--:|------|
| **requests** (54k⭐) | **2.00** | 2 | 2 | 2 | 2 | 2 | 成熟开源 |
| **flask** (72k⭐) | **1.85** | 2 | 2 | 2 | 1 | 2 | 成熟开源 |
| **ruff** (49k⭐) | **1.85** | 2 | 2 | 2 | 1 | 2 | 商业开源 |
| **Semgrep** (16k⭐) | **1.85** | 2 | 2 | 2 | 1 | 2 | 商业开源 |
| **LangChain** (144k⭐) | **1.85** | 2 | 2 | 2 | 1 | 2 | 商业开源 |
| **httpx** (15k⭐) | **1.15** | 2 | 1 | 2 | 0 | 0 | 新兴开源 |
| **MergeGate** | **0.60** | 1 | 1 | 0 | 1 | 0 | 个人开源 |
| **竞品雷达** | **0.60** | 1 | 1 | 0 | 1 | 0 | 个人开源 |

> 得分范围 0.00-2.00。五维权重：差异化 25%、护城河 25%、定位 20%、工程 15%、可持续 15%。本表为单次评测快照，LLM 打分存在波动（见关键发现）。

### 关键发现

- **知名开源项目高分聚集**：5 个成熟项目得分集中在 1.85-2.00，框架对头部项目的区分度有限——stars 破 5000 后护城河自动 2 分，工程/可持续也普遍 1-2 分
- **httpx 进入维护模式**：工程 0 分（近 90 天无 commit，硬阈值校准）+ 可持续 0 分（LLM 误判为"超 12 个月未更新"，实际约 4.5 个月）
- **个人项目持续垫底**：MergeGate / 竞品雷达 0.60，与成熟项目差距明显，框架仍能区分"头部开源 vs 个人项目"两档
- **LLM-as-a-Judge 存在时间波动**：requests 在 2026-08-09 得 1.85、本次 2.00，波动来自竞品搜索结果不同 + LLM 输出随机性——单次评分仅作参考，跨时间对比需多次采样
